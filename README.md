...
*The domain lists in this repository are autogenerated — pull requests editing them directly will be overwritten. To add or remove a domain, please open [an issue](https://github.com/disposable/disposable/issues) or submit a PR in the [main repository](https://github.com/disposable/disposable).*
